      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-lg-5 box">
                  <?php echo '<img src="'.$data['Poster'].'" alt="'.$data['Title'].'" class="movie-img"/>'; ?>
              </div>
              
              <div class="col-lg-7 box">
                <h3><?php echo $data['Title']; ?></h3>
                <ul class="uk-subnav uk-subnav-line">
                    <li class="single-rating"><i class="fa fa-star" aria-hidden="true"></i><?php echo $data['imdbRating']; ?><span>/10 (<?php echo $data['imdbVotes']; ?> Votes)</span></li>
              ...
              <iframe width="100%" height="500px" src="<?php echo $movie['video_url']; ?>"></iframe>
        </div>
      </div>
</main>
